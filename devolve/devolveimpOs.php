...
$sqlcimp="select * from vw_os where cod_os =".$cod_os.";";
$rscimp=pg_query($conexao,$sqlcimp);
$impos=pg_fetch_array($rscimp);

$sqlreg="select reg_descricao from tb_registro where cod_os='".$cod_os."' and cod_tipo_reg='5';";
$rsreg=pg_query($conexao,$sqlreg);
$impreg=pg_fetch_array($rsreg);

$sqlinsreg="insert into tb_registro (cod_os,cod_tipo_reg,cod_funcionario,reg_descricao) values ('".$cod_os."',6,'".$cod_funcionario."','".$reg_descricao."');";
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td colspan="3" align="center"><?php echo $impreg['reg_descricao']?></td>
    <tr>
