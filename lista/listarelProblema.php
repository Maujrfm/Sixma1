...
if($problema!="")
{
	$sqlconsprob="select * from vw_os where cod_problema=".$problema." order by cliente asc,cod_os desc  ;";
	$rscons=pg_query($conexao,$sqlconsprob);
...
{
	echo "<script> alert('Selecione um problema'); </script>";
}
 pg_close($conexao);
?>
<body>
