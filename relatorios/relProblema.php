...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btfil').click(function(){
             $('#list').load('../lista/listarelProblema.php?problema='+$('#problema').val());
       });
    });
    </script>
...
<tr class="nao_imprimir">
  ...
  <tr>
    ...
    <tr class="nao_imprimir">
            ...
            <td width="25%" align="left"><select style="width:100%" name="tipo" id="tipo" size="1" >
	...
	echo"<option value=\"".$des_equip['cod_tipo']."\">". $des_equip['tipo_descricao']."</option>";
     ...
     <tr class="nao_imprimir">
     <td>Produto:</td>
     <td width="25%" align="left"><select style="width:100%" name="produto" id="produto" size="1" >
                <option  selected="selected"></option>
              </select></td></tr>
    <tr class="nao_imprimir">
    <td >Problema:</td>
    <td >
    <select name="problema" style="width:100%" id="problema" size="1" >
    <option  selected="selected"></option>
    </select></td></tr>
    <tr>
