...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btfil').click(function(){
             $('#list').load('../lista/listarelTipo.php?tipo='+$('#tipo').val());
       });
    });
    </script>
...
<tr class="nao_imprimir">
  ...
  <tr>
    ...
    <select style="width:100%" name="tipo" id="tipo" size="1" >
                ...
                <?php 
	while($des_tipo=pg_fetch_array($rstipo))
	{
	echo "<option id=\"tipo\" value=\"".$des_tipo['cod_tipo']."\">".$des_tipo['tipo_descricao']."</option>";
	}?></select></td></tr>
    <tr>
