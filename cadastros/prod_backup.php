...
$sqlmod="select * from tb_modelo order by mod_descricao";
...
<form method="post" action="bancodedados.php">
  <input type="hidden" name="validador" value="10" />
  <table border="0">
    <tr>
    ...
    <tr>
      ...
      <td>
      <select style="width:100%" name="mod" id="mod" size="1" >
          <option  selected="selected"></option>
        </select
    ></td>
    </tr>
    <tr>
      ...
      <td><input type="text" name="nst" size="30" maxlength="150" autocomplete="off" /></td>
    </tr>
    <tr>
