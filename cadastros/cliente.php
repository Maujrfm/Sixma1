...
<input type="hidden" name="validador" value="2" />
<table border="0">
<tr>
<td>Nome da Empresa:</td>
<td><input type="text" name="cli_empresa" size="30" maxlength="150" autocomplete="off" /></td></tr>
<tr>
<td>CNPJ:</td>
<td><input type="text" class="CNPJ" name="cnpj" size="30" maxlength="150" autocomplete="off" /></td></tr>
<tr>
<td>Contato:</td> 
<td><input type="text" name="cli_contato" size="30" maxlength="150" autocomplete="off" /></td></tr>
<tr>
<td>Telefone:</td>
<td><input type="tel" class="Telefone" name="cli_telefone" size="30" maxlength="150" autocomplete="off" /></td></tr>
<tr>
<td>Email:</td>
<td><input type="text" name="cli_email" size="30" maxlength="150" autocomplete="off" /></td></tr>
<tr>
