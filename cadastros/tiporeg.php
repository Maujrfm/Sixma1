...
<input type="hidden" name="validador" value="9" />
<table border="0">
<tr>
<td align="center">Tipo de Registro:</td>
<td><input type="text" name="tipo_registro" size="30" maxlength="150" autocomplete="off" /></td></tr>
<tr>
