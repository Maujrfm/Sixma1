...
<script type="text/javascript">
	...
	$(document).ready(function(){
        $('#btfil').click(function(){
			 ...
			 $('#list').load('../lista/listaromDespacho.php?romaneio='+$('#romaneio').val()+'&codimp='+valor);
       });
    });
    </script>
...
<script type="text/javascript">
   function cancelar(){
	window.setTimeout("location.href='../administrativo.php';",1)
    }
    </script> 
...
<tr class="nao_imprimir">
    ...
    <td align="center" bgcolor="" width="60%"><h1> Romaneio Despacho</h1></td>
  ...
  <tr>
    ...
    <tr class="nao_imprimir">
    <td align="center">Romaneio</td>
    <td width="70%">
    <input style="width:100%" name="romaneio" id="romaneio" size="1" >
                </td></tr>
    <tr>
