...
?>
<body>
<form method="post" action="../imprime/imprimeromDespacho.php">
<input type="hidden" name="codrom" value="<?php echo $codrom ?>">
<input type="hidden" name="nf" value="<?php echo $nf ?>">
<input type="hidden" name="qtdv" value="<?php echo $qtdv ?>">
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
    ...
    <tr><th colspan="4"><h2>Destinatário</h2></th></tr>
    <tr>
    ...
    <td><a href="../romaneio/romDespacho.php"><input type="button" name="cancelar" value="cancelar"></a></td></tr>
</table></form>
